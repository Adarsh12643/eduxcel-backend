    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-black mb-1">Class Analytics</h2>
          <p className="text-brand-100 text-sm max-w-xl">Comprehensive performance insights for your cohort.</p>
        </div>
      </div>
