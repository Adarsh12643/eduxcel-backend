    ...
    <div className="space-y-6">
      <div className="p-6 rounded-2xl bg-gradient-to-r from-brand-600 to-indigo-600 dark:from-brand-700 dark:to-indigo-700 text-white relative overflow-hidden mb-6">
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-black mb-1">Academic Goal Calculator</h2>
          <p className="text-brand-100 text-sm max-w-xl">Use the "What If?" mode to simulate grade improvements.</p>
        </div>
      </div>
