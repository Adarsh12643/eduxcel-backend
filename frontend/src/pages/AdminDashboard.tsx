    ...
    <div className="space-y-6">
        ...
        {[
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-emerald-500 text-sm font-bold bg-emerald-50 dark:bg-emerald-900/30 px-2 py-0.5 rounded-full">
                {stat.trend}
              </span>
            </div>
            <h3 className="text-slate-500 dark:text-slate-400 text-sm font-semibold">
              {stat.title}
            </h3>
      ...
      >
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
          This dashboard is configured to overview institution-wide analytics
          and manage global settings.
        </p>
      </motion.div>
    </div>
  );
  ...
  const getHeaderInfo = () => {
    ...
    if (p.includes("analytics"))
      return {
        ...
        subtitle: "Global metrics and system performance.",
      };
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F9] dark:bg-dark-bg flex font-sans text-brand-900 dark:text-slate-100 overflow-x-hidden relative flex-col md:flex-row transition-colors duration-500">
            ...
            >
              ...
              {!collapsed && (
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold text-brand-900 dark:text-white tracking-tight truncate">
                    {userName}
                  </p>
                  <p className="text-[10px] text-brand-500 dark:text-brand-400 font-mono tracking-tighter uppercase truncate">
                    {userEmail}
                  </p>
                </div>
              )}
      ...
      <main
        ...
        style={{
          marginLeft: sidebarW + sidebarPad,
      ...
      >
        ...
        <header className="glass-panel dark:glass-panel h-16 flex items-center justify-between px-6 z-10 flex-shrink-0 rounded-2xl mb-4">
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
        ...
        <div className="flex-1 overflow-y-auto pb-5">
          ...
          <footer className="mt-12 py-6 border-t border-slate-200 dark:border-slate-700 text-center text-sm text-slate-500 dark:text-slate-400 w-full">
            © {new Date().getFullYear()} EduXcel AI.{" "}
